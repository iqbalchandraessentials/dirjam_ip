        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="user-header text-center" style="margin-top: 20px;">
                <div style="display: flex; justify-content: center; align-items: center;">
                    <img src="{{ Session::get('user')['photo'] }}" class="rounded-circle" style="width: 80px; height: 80px;" alt="User Image">
                </div>
            </li>
            <li class="header nav-small-cap text-uppercase text-white text-center">
                {{ Session::get('user')['nama'] }}
                <br>
                {{ Session::get('user')['role'] ?? Session::get('user')['ou'] }}
            ...
            <li class="treeview {{ Request::segment(1) === 'master_data' ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ Request::is('master_data/users', 'master_data/tambah-roles') ? 'active' : '' }}">
